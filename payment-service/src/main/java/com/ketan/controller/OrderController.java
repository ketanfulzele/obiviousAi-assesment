...
public class OrderController {
	...
	@CircuitBreaker(name = "order-circuit" , fallbackMethod = "placeOrder_fallback")
	public ResponseEntity<OrderResponseBean> createOrder(@RequestBody orderBean orderBean) {
	...
	public ResponseEntity<Object> placeOrder_fallback(Throwable th) {
