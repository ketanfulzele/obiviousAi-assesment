...
public interface ProductFeignClient {
	...
	public ResponseEntity<String> reserveProduct(@PathVariable("productId") int id, @PathVariable int qauntity);

	@GetMapping("/inventory/reset/{productId}/{qauntity}")
	public ResponseEntity<String> resetProduct(@PathVariable("productId") int id, @PathVariable int qauntity);
}
